...
private_section: 课外
sitemap: false
description: 之前那条线：GAMES101 图形学与 Tom Looman 的 UE5 C++，合起来 16 篇复盘。
---

<header class="noimpty-hero noimpty-hero--gamedev">
  <nav class="noimpty-hero__crumbs" aria-label="所在位置"><a href="/extra/">extra</a></nav>
  <h1 class="noimpty-hero__title">游戏开发</h1>
  <p class="noimpty-hero__sub"><span>GAMES101 · UE5 C++</span><span>2 门课</span><span>{% section_stat GAMES101|UE5-Looman %}</span><span>告一段落</span></p>
</header>
...
<details class="noimpty-fold">
  ...
  <p>两门课，一条线：图形学回答「屏幕上那张图是怎么算出来的」，Unreal 回答「一个游戏是怎么组织起来的」。方向后来转去了 AI Infra，但这些东西没有作废 —— 把 MVP 变换推一遍、把 Gameplay Framework 的职责拆清楚，练的是同一种能力：<b>不满足于「能跑」，要知道每一层各自在负责什么。</b></p>
</details>
