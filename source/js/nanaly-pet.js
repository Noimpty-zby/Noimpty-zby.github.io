...
(() => {
  ...
  const mountToggle = () => {
    ...
    // 猫脸轮廓，和左下角另外两个按钮一样是 54×54 的圆
    button.innerHTML = '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">'
      + '<path d="M4 11 3.4 4.6q-.1-1.2 1-.5L8.6 7M20 11l.6-6.4q.1-1.2-1-.5L15.4 7"/>'
      + '<path d="M4 11.5Q5 6.6 12 6.6T20 11.5l.8 3.6q0 6.3-8.8 6.6-8.8-.3-8.8-6.6Z"/>'
      + '<circle cx="8.8" cy="13.6" r="1.25"/><circle cx="15.2" cy="13.6" r="1.25"/>'
      + '<path d="M12 16.2q-1.4 2.4-2.6.4m2.6-.4q1.4 2.4 2.6.4"/></svg>'
