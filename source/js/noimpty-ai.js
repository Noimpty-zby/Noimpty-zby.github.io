...
- **他现在的主线是两条，都刚起步，各写了一篇 —— 这两篇博客上真的有，别否认：**
  「课内 · 数据结构与算法」（Abdul Bari，C/C++）：《数据结构第一章：内存怎么排、
  ...
  「课外 · AI Infra 后端开发」：《Linux 命令行第一章：终端、Shell 与内核各自在干什么》。
- 除上面点到的之外，其余栏目（CSAPP、Linux 深入、Git、Go、MySQL、Docker、
